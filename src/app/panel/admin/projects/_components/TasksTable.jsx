  ...
  return (
    <div className="w-full flex flex-col items-center gap-6">
      ...
      {tasks.length <= 0 ? (
        ...
        <div className="w-full sm:overflow-x-hidden overflow-x-auto bg-[#F1F7FF] border-2 border-[#E0EDFF] !rounded-[20px] mb-7">
          <table className="w-full min-w-[600px] border-collapse">
            <thead className="w-full p-3">
              <tr className="">
                <th className="border border-[#E0EDFF] p-3 sm:text-[20px] text-[16px] font-semibold text-[#073362] VazirmatnBold">
                  عنوان
                </th>
                <th className="border border-[#E0EDFF] p-3 sm:text-[20px] text-[16px] font-semibold text-[#073362] VazirmatnBold">
                  مسئول
